# Briefing: neue Website Förderverein Völkerschlachtdenkmal e.V.
...
- **Objekt:** Förderverein Völkerschlachtdenkmal e.V.
- **Ort:** Leipzig
- **Bisherige Website:** https://www.voelkerschlachtdenkmal.de/
- **Anlass:** Empfehlung von Tessina-Larissa Schramm (Marketing, Kontakt beim Stadtgeschichtlichen Museum Leipzig / Voelkerschlachtdenkmal), Mail vom 03.08.2026: das Museum lehnt den VSD-Pitch ab (baut selbst eine neue Seite, die auch die Satelliteneinrichtungen abdeckt), empfiehlt aber ausdruecklich, den dem Haus nahestehenden Foerderverein anzusprechen - dessen Seite koenne eine Auffrischung vertragen.
- **Zielordner im Repo:** foerderverein-voelkerschlachtdenkmal-e-v-e5a14e167e44467b
- **Spaetere Adresse:** https://nx7-projects.github.io/Leads/foerderverein-voelkerschlachtdenkmal-e-v-e5a14e167e44467b/

## 2. Ist-Stand und Messlatte

Befund zur bisherigen Seite (aus der Recherche, MATERIAL):

> voelkerschlachtdenkmal.de (Foerderverein, nicht das Museum selbst): PHP-Seite mit linker Sidebar-Navigation, wirkt wie fruehe-2000er-Bauweise, statisches institutionelles Design. Inhalte werden laufend gepflegt (Aktivitaeten-Archiv bis 2026) aber Design/Struktur seit Jahren unveraendert. ~250 Mitglieder, Spenden/Mitgliedschaft, Ehrenbuch- und Plaketten-Anerkennung fuer Spender, dokumentierte Sanierungsprojekte seit 1998.

**Die Abnahme misst genau eine Frage:** Sieht die neue Seite besser aus als https://www.voelkerschlachtdenkmal.de/?
...
3. **Sieht sie besser aus als https://www.voelkerschlachtdenkmal.de/?** - das ist das eigentliche Kriterium.
