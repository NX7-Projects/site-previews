# Briefing: neue Website Torhaus Dölitz mit Zinnfigurenmuseum
...
- **Objekt:** Torhaus Dölitz mit Zinnfigurenmuseum
- **Ort:** Leipzig
- **Bisherige Website:** http://www.torhaus-doelitz.eu/
- **Anlass:** Vereinsgetragenes Museum (Verband Jahrfeier Völkerschlacht bei Leipzig 1813 e.V. mit den Zinnfigurenfreunden), laut Stadt Leipzig eines der größten Zinnfigurenmuseen Europas: über 100.000 Figuren und Dioramen auf drei Etagen, historischer Schauplatz der Völkerschlacht 1813, TripAdvisor-Rezensionen durchweg begeistert, aktives Veranstaltungsprogramm bis 2027 gepflegt
- **Zielordner im Repo:** torhaus-doelitz-0191f14d90cb3d92
- **Spaetere Adresse:** https://nx7-projects.github.io/Leads/torhaus-doelitz-0191f14d90cb3d92/

## 2. Ist-Stand und Messlatte

Befund zur bisherigen Seite (aus der Recherche, MATERIAL):

> WordPress-Seite technisch von 2014 (Copyright 2014, jQuery 1.7.1 von 2011): kein funktionierendes HTTPS (TLS-Fehler auf Port 443, Seite nur per http erreichbar), kaputtes HTML-Wurzelelement in Zeile 1, unverschlüsselt eingebundene Fremd-CDNs (Google Fonts, ajax.googleapis.com, maxcdn), Cookie-Banner nach verworfenem Opt-out-Muster; Inhalte gepflegt und umfangreich (Sonderausstellungen, Dioramen, Vermietung, Patenschaften) - die Technik hält mit dem lebendigen Haus nicht mehr Schritt

**Die Abnahme misst genau eine Frage:** Sieht die neue Seite besser aus als http://www.torhaus-doelitz.eu/?
...
3. **Sieht sie besser aus als http://www.torhaus-doelitz.eu/?** - das ist das eigentliche Kriterium.
